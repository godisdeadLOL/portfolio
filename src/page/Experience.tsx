		...
		<section>
			...
			<div class="space-y-4">
				...
				<Card>
					...
					<div class="text-justify">Делал игры для Яндекс.Игр — разработал около десяти штук. Получилось немного заработать на монетизации.</div>

					<Collapsible title="примеры" className="mt-4 mb-6 -mx-2">
						<Link target="_blank" to="https://yandex.ru/games/app/281797">
							Падение Нубика
						</Link>
						<Link target="_blank" to="https://yandex.ru/games/app/432647">
							Безумная Кирка
						</Link>
						<Link target="_blank" to="https://yandex.ru/games/app/442334">
							Резня Плейграунд
						</Link>
					</Collapsible>
